import { validateEnvironmentVariables, validateDiscordChannelId, validateYouTubeChannelId } from '../config-validator.js';
...
export class Configuration {
  ...
  getAllConfig(includeSecrets = false) {
    ...
    for (const [key, value] of Object.entries(this.env)) {
      if (key.startsWith('DISCORD_') || key.startsWith('YOUTUBE_') || key.startsWith('X_') || key.startsWith('WEBHOOK_')) {
